local _0_0 = nil
do
  local name_0_ = "centerfold.aniseed.test"
...
local function _2_(...)
  ...
  local function _2_()
    return {require("centerfold.aniseed.core"), require("centerfold.aniseed.nvim"), require("centerfold.aniseed.string")}
  end
  ok_3f_0_, val_0_ = pcall(_2_)
  if ok_3f_0_ then
    _0_0["aniseed/local-fns"] = {require = {a = "centerfold.aniseed.core", nvim = "centerfold.aniseed.nvim", str = "centerfold.aniseed.string"}}
    return val_0_
  else
    return print(val_0_)
  end
...
local _2amodule_name_2a = "centerfold.aniseed.test"
