...
local _2amodule_name_2a = "centerfold.aniseed.env"
local _2amodule_2a
do
...
local compile, fennel, fs, nvim = autoload("centerfold.aniseed.compile"), autoload("centerfold.aniseed.fennel"), autoload("centerfold.aniseed.fs"), autoload("centerfold.aniseed.nvim")
