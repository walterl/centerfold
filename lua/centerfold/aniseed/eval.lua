...
local a, compile, fennel, fs, nvim = autoload("centerfold.aniseed.core"), autoload("centerfold.aniseed.compile"), autoload("centerfold.aniseed.fennel"), autoload("centerfold.aniseed.fs"), autoload("centerfold.aniseed.nvim")
