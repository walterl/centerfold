...
local a, fs, nvim, str = autoload("centerfold.aniseed.core"), autoload("centerfold.aniseed.fs"), autoload("centerfold.aniseed.nvim"), autoload("centerfold.aniseed.string")
...
local function impl()
  local compiler = require("centerfold.aniseed.deps.fennel")
