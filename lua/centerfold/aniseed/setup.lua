...
local _2amodule_name_2a = "centerfold.aniseed.setup"
local _2amodule_2a
do
...
local a, env, eval, nvim = autoload("centerfold.aniseed.core"), autoload("centerfold.aniseed.env"), autoload("centerfold.aniseed.eval"), autoload("centerfold.aniseed.nvim")
