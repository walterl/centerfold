local _0_0 = nil
do
  local name_0_ = "centerfold.aniseed.compile"
...
local function _2_(...)
  ...
  local function _2_()
    return {require("centerfold.aniseed.core"), require("centerfold.aniseed.fennel"), require("centerfold.aniseed.fs"), require("centerfold.aniseed.nvim")}
  end
  ok_3f_0_, val_0_ = pcall(_2_)
  if ok_3f_0_ then
    _0_0["aniseed/local-fns"] = {require = {a = "centerfold.aniseed.core", fennel = "centerfold.aniseed.fennel", fs = "centerfold.aniseed.fs", nvim = "centerfold.aniseed.nvim"}}
    return val_0_
  else
    return print(val_0_)
  end
...
local _2amodule_name_2a = "centerfold.aniseed.compile"
...
do
  ...
  do
    ...
    local function macros_prefix0(code)
      local macros_module = "centerfold.aniseed.macros"
