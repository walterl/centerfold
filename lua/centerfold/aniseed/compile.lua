...
local a, fennel, fs, nvim = autoload("centerfold.aniseed.core"), autoload("centerfold.aniseed.fennel"), autoload("centerfold.aniseed.fs"), autoload("centerfold.aniseed.nvim")
